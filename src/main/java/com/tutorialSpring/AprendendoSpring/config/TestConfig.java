...
import com.tutorialSpring.AprendendoSpring.entities.Payment;
...
import com.tutorialSpring.AprendendoSpring.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(0, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.DELIVERED, u2);
		Order o3 = new Order(0, Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.DELIVERED, u1); 
		...
		//adicionar categorias nos produtos para salvar na tabela product_category
		...
		//Salvar pagamento conexao 1 por 1
